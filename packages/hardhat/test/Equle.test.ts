...
describe("Equle", function () {
  ...
  describe("Functionality", function () {
    ...
    it("Should guess and unseal the result", async function () {
      ...
      // MAKE THIS ANOTHER TEST FOR RESULT FEEDBACK 0, 1, 2
      ...
      console.log("unsealedEquationXor", unsealedEquationXor);
      console.log("unsealedEquationXor.data!", unsealedEquationXor.data!);

      // Analyze the XOR result for Wordle-style feedback
      const feedback = analyzeXorResult(unsealedEquationXor.data!);
      console.log("Wordle feedback:");
      console.log("Green (correct position):", feedback.green);
      console.log("Yellow (wrong position):", feedback.yellow);
      console.log("Gray (not present):", feedback.gray);
    });
  });
});
